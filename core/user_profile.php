...
<div class="save">
<button class="button-24" role="button" id="openMyPopup" data-popup="myPopup" onClick="openPopup('#myPopup')" aria-controls="myPopup" aria-label="Open popup">Saves</button>
</div>
<div class="chat">
<button class="button-24" role="button" id="openMyPopup" data-popup="myPopup" onClick="openPopup('#myPopup')" aria-controls="myPopup" aria-label="Open popup">Chat</button>
</div>
</div>
</div>
<form action="logout.php" method="post">
	...
	<div class="wrapper" aria-labelledby="popupTitle" aria-describedby="popupText" aria-modal="true">
		<h2 id="popupTitle">COMMING SOON !</h2>
		<button class="button-24" role="button" id="closePopup" onClick="closePopup('#myPopup');" aria-label="Close popup">Close</button>
	</div>
</div>
...
<div class="card-container">
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            echo '<img class="round" src="' . $row['profileImage'] . '" width="150px" height="150px" alt="user" />';
...
<div class="friend-list">
    ...
    <ul class="friend-list-items">
        ...
        while ($row = $result->fetch_assoc()) {
            echo "<li>";
            echo "<a href='user_details.php?id=" . $row["id"] . "' style='display: flex; align-items: center;'>";
            echo "<img src='" . $row["profileimage"] . "' alt='" . $row["username"] . "' width='50' height='50'>";
            echo "<span>" . $row["username"] . "</span>";
            echo "</a>";
            // Add "Follow" and "Unfollow" buttons with data-userid attribute
